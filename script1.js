...
function Ai() {
  ...
  this.control = function(x, y, t, te) {
    this.x = x;
    this.y = y;
    this.t = t;
    this.team = te;
  ...
  this.draw = function() {
    ...
    draw.fillRect(this.x + 5, this.y + 5, 40, 40);
  }
}
...
function loading() {
  ...
  interval2 = window.setTimeout(mainMenu, 2000);
...
function enemy(x, y, m, team) {
  if (m) {
    Game.aiId++;
    ai[Game.aiId] = new Ai();
    ai[Game.aiId].control(x, y, team);
  }
}
startScreen();
